...
def get_recipe():
    try:
        ...
        prompt = f"You are strictly, a friendly Nigerian cooking assistant and you only know Nigerian dishes. I want you to give me a detailed, authentic Nigerian recipe for {food_name}. \
